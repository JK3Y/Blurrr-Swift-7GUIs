...
if(BLURRR_USE_SWIFT)
	...
	list(APPEND BLURRR_USER_SWIFT_COMPILED_FILES
		${PROJECT_SOURCE_DIR}/source/BlurrrMain.swift
		${PROJECT_SOURCE_DIR}/source/IupSwiftBinding.swift
	)
...
list(APPEND BLURRR_USER_COMPILED_FILES
	${PROJECT_SOURCE_DIR}/source/main_swift.c
	${PROJECT_SOURCE_DIR}/source/iupvalist.c
	${PROJECT_SOURCE_DIR}/source/iupvalist.h
)
